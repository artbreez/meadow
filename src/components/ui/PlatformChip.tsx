...
const platformConfig: Record<Platform, {
  ...
  instagram: { label: 'Instagram', color: 'var(--platform-ig)', bg: 'var(--platform-ig-bg)', Icon: InstagramIcon },
  tiktok:    { label: 'TikTok',    color: 'var(--platform-tt)', bg: 'var(--platform-tt-bg)', Icon: TikTokIcon    },
  youtube:   { label: 'YouTube',   color: 'var(--platform-yt)', bg: 'var(--platform-yt-bg)', Icon: YouTubeIcon   },
}
